...
select ok(has_function_privilege('authenticated','assert_fms_flow_publishable(uuid)','EXECUTE'),'publish validation is available to authenticated builders without publishing');
