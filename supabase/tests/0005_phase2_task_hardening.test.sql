...
select is((select count(*)::integer from notification_events where event_type='task_coverage_required' and tenant_id='10000000-0000-0000-0000-000000000001'), 1, 'blocked coverage creates one canonical notification event');
