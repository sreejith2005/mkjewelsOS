-- Keep leave history and import identity aliases in the retained operational data.
-- The existing retirement manifest fails closed until new tenant tables are classified.
...
declare
  ...
  v_classified constant text[] := array[
    ...
    'role_permissions','user_access_profiles','user_permission_overrides'
  ];
begin
