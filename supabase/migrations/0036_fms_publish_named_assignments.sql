-- Authoring and publishing validate durable named ownership. Operational
-- eligibility (login enabled, working status and today's absence) is resolved
-- when a workflow instance activates the step and may use its named fallback.
