...
export function ImportReadinessSummary({ total, ready, blocked, assigned, assigningLeft, recurring, startDate, unresolvedLabels, unresolvedNamed }: Props) {
  ...
  const cards = [
    ["Source records", number.format(total)],
    ["Ready to import", number.format(ready)],
    ["Blocked rows", number.format(blocked)],
