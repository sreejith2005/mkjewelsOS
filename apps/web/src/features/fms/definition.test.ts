...
describe("FMS web definition adapter", () => {
  ...
  it("rehydrates graph relationships while leaving legacy role assignments out of the named-user editor", () => {
    ...
    ], assignees:[{fms_stage_id:"s1",assignee_type:"reporter",user_profile_id:null,role_value:null,allow_next_selection:false,sort_order:0}], branchRules:[], forms:[], users:[], availability:[], branches:[], departments:[] } satisfies FmsData;
