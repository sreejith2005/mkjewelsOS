  ...
  return (
    <section>
      <header className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3"><span className="rounded-xl bg-gold p-2.5 text-obsidian"><ListFilter className="h-5 w-5" /></span><div><h1 className="font-display text-2xl sm:text-3xl text-gold">Dropdown Master</h1><p className="text-sm text-soft-grey">Manage real shared option lists</p></div></div>
        <Button className="w-full sm:w-auto" onClick={() => setEditing(null)}><Plus className="h-4 w-4" />Add item</Button>
      </header>
