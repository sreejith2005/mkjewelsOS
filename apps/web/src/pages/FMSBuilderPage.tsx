...
export function FMSBuilderPage() {
  ...
  const [startFlowId, setStartFlowId] = useState<string | null>(null);
  ...
  return <section className="mx-auto w-full max-w-7xl space-y-5">
    ...
    {view === "live" ? <FMSTasksPage query={query} /> : !canBuild ? <Notice>Workflow creation is available to authorized managers.</Notice> : <section>
