...
export function AvailabilityPage() {
  ...
  return <section>
    <header className="mb-6 flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-3"><span className="rounded-xl bg-gold p-2.5 text-obsidian"><CalendarCheck className="size-5" /></span><div><h1 className="font-display text-2xl text-gold sm:text-3xl">Availability</h1><p className="text-sm text-soft-grey">{date} - an authorized absence immediately checks work due today or tomorrow.</p></div></div>
