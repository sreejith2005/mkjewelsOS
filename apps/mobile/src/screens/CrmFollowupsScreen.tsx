...
export function CrmFollowupsScreen() {
  ...
  if (loading && !data) return <Screen><LoadingState label="Loading follow-ups…" /></Screen>;
...
const useStyles = makeStyles((theme) => StyleSheet.create({ actions: { flexDirection: "row", flexWrap: "wrap", gap: theme.space.xs, marginTop: theme.space.sm } }));
