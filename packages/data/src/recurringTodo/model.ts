...
// The two display rules below live in `@jewelos/core` so the phone and the
// browser cannot disagree about when an occurrence reads as overdue or as work
// still owed. They are re-exported here so every existing import keeps working.
export { recurringInstanceDisplayStatus, recurringInstanceNeedsWork } from "@jewelos/core";
