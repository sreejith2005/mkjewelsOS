import { fetchEmployeeTaskProgress, fetchReportingOptions, type ReportingOptions } from "../analytics/api";
import type { EmployeeProgress, ProgressCounts } from "../analytics/types";
import { fetchTaskEvidenceWorkspace } from "../taskEvidence/api";
import type { EvidenceWorkspace, TaskView } from "../taskEvidence/types";
